...
public class MyImgScroll extends ViewPager {
    ...
    public void start(Activity mainActivity, List<View> imgList,
            int scrollTime, LinearLayout ovalLayout, List<News> list,
            TextView tv, int ovalLayoutId, int ovalLayoutItemId, int focusedId,
            int normalId) {
        mActivity = mainActivity;
        mListViews = imgList;
        mScrollTime = scrollTime;
        setOvalLayout(ovalLayout, list, tv, ovalLayoutId, ovalLayoutItemId,
                focusedId, normalId);
    ...
    private void setOvalLayout(final LinearLayout ovalLayout,
            final List<News> list, final TextView textview, int ovalLayoutId,

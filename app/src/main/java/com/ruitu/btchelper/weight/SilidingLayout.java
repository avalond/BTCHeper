...
public class SilidingLayout extends LinearLayout implements View.OnTouchListener {
    private static final String TAG = SilidingLayout.class.getSimpleName();
    /**
     ...
     */
    private int leftLayoutPadding = 180;
     ...
     * @param attrs
     */
    public SilidingLayout( Context context, AttributeSet attrs ){
        super( context, attrs );
    ...
    public boolean onTouch( View v, MotionEvent event ){
        ...
        switch ( event.getAction() ) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                xUp = event.getRawX();
                yUp = event.getRawY();
                m_distanceX = ( int ) ( xUp - xDown );
                m_distanceY = ( int ) ( yUp - yDown );
